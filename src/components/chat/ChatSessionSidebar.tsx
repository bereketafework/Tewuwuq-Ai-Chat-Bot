...
export function ChatSessionSidebar({
  ...
  return (
    <>
      ...
      <SidebarContent className="p-2 flex-grow"> {/* Ensure content can grow and scroll */}
        <ScrollArea className="h-full w-full"> {/* ScrollArea takes full height of SidebarContent */}
          {sessions.length === 0 ? (
                    ...
                    <div
                      ...
                      className={cn(
                        ...
                        activeSessionId === session.id
                          ...
                          : 'hover:bg-muted text-foreground', // Adjusted hover for non-active
                      )}
                      title={session.title}
                    >
      ...
      <SidebarFooter className="p-2 border-t border-border text-center text-xs text-muted-foreground shrink-0">
